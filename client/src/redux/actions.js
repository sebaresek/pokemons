...
export const getAllPokemons = () => async (dispatch) => {
  try {
    await axios.get("https://servidor-pokemon-pzmd.onrender.com/types/");
    const result = await axios.get("https://servidor-pokemon-pzmd.onrender.com/pokemons/");
    dispatch({
...
export const deletePokemon = (id) => {
  return async (dispatch) => {
    try {
      await axios.delete(`https://servidor-pokemon-pzmd.onrender.com/pokemons/${id}`);
      dispatch({
        type: DELETE_POKEMON,
        payload: id
      });
